...
const Modal = ({ idxModal, setShowModal, setIdxModal }) => {
    ...
    return(
        ...
        <EditButton onClick={e => {dispatch(edit({idx: idxModal, todo, editedToDo: text})); setShowModal(false); setIdxModal(undefined)}}>Edit</EditButton>
        <RemoveButton onClick={(e) => {dispatch(remove({idx: idxModal, todo})); setShowModal(false); setIdxModal(undefined)}}>Remove</RemoveButton>
        <CancelDiv>
